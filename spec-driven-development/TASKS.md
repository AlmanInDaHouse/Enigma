...
| 5 | 6 | 4 | 67% | T-501: `bootstrap.ps1` vía winget, idempotente. T-502: `setup-windows.md` reescrito. T-503: `usuario-final.md` para no-técnicos. T-504: `enigma stats` (corpus+actividad+salud); latencia de pipeline por llamada no instrumentada (mejora futura). |
