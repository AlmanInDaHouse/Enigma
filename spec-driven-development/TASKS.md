...
| 5 | 6 | 5 | 83% | T-501: `bootstrap.ps1` vía winget. T-502: `setup-windows.md` reescrito. T-503: `usuario-final.md`. T-504: `enigma stats`; latencia de pipeline no instrumentada (mejora futura). T-505: `backup`/`restore` (Qdrant se reconstruye reindexando, no se respalda el binario). |
